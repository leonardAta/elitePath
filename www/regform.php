    ...
    include 'includes/regheader.php';
        ...
        if (!$_POST['email'] || !filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
         ...
         // Check if phone has been entered
          ...
          // Check if course has been entered
                if (!$_POST['course']) {
                    $errCourse = 'Please select a course';
                }       
         // Check if qualification has been entered
                if (!$_POST['qualification']) {
                    $errQualification = 'Please enter a qualification';
                }
...
if (!$errName && !$errEmail && !$errPhone && !$errCourse && !$errQualification && !$errMessage ) {
    if (mail ($to, $subject, $body, $from)) {
        $result='<div class="alert alert-success">Thank You! We will be in touch with you.</div>';
    } else {
    ...
    <body>
       ...
       <div id="js__scroll-to-appointment" class="g-bg-color--sky-light g-padding-y-80--xs g-padding-y-125--sm">
        ...
        <div class="row">
            ...
            <h1 class="page-header text-center" style="color: green;">Thank You from elitePath. We Will Get In Touch With You</h1>
